## Project 1: Differents grpahs related to Electric Power Consumption from 2007-02-01 and 2007-02-02
...
## Graph 2
with(epc, plot(Voltage~ complete_date, type="l", col="black", ylab="Voltage", xlab="datetime"))

## Graph 3
with(epc, plot(Sub_metering_1~ complete_date, type="l", col="black", xlab="", ylab="Energy sub metering"))
...
## Graph 4
with(epc, plot(Global_reactive_power~ complete_date, type="l", xlab="datetime", ylab="Global_reactive_power"))
